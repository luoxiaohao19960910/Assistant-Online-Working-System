                ...
                <div class="layui-card-body" pad15>
                    ...
                    <div class="layui-form" lay-filter="">
                        ...
                        <div class="layui-timeline-content layui-text">
                            ...
                            <ul>
                                <li>开班电话表中姓名单元格的<b style="color:red">颜色含义</b>：该学生当前季度在你的所有班上重复的次数。如，你有5个班级：A、B、C、D、E，学生张三同时在你的A、B、C班上，那么该学生重复次数为3。
                                    <br>重复次数与颜色对应关系：
                                    <br>无背景色——1次
                                    <br>绿色——2次
                                    <br>蓝色——3次
                                ...
                                <li>新生和老生的判别标准：从本系统中之前的上课记录中查，有则老生；反之新生。如果你的校区本季度刚刚开始使用本系统，那么所有学生都会被判定为新生！</li>
                                <li>座位表：系统根据学生进班时间从低到高排座位。<b style="color:red">对于满班的班级，超出教室容量的那部分学生不会被排到座位表中。</b>
                            </ul>
                        </div>
                    </div>
                </div>
